...
(function(){
	this.Tank = function (width , length , color){
		/*
	...
	this.Tank.prototype.set_tank_position = function( position_vector){
	...
	this.Tank.prototype.set_tank_angle = function(angle){
		if(angle != null)
		{
			if(angle < 0)
				angle += 360;
	...
	this.Tank.prototype.set_gun_angle = function(angle){
		if(angle != null)
		{
			if(angle < 0)
				angle += 360;
	...
	this.Tank.prototype.set_tank_color = function(color){
		if(color == null)
			return;
	...
	this.Tank.prototype.get_tank_position = function(){
		return this.current_position; // returns a position vector.
	}

	this.Tank.prototype.get_tank_angle = function(){
		return this.tank_orientation.tank_angle;
	}

	this.Tank.prototype.get_gun_angle = function(){
		return this.tank_orientation.gun_angle;
	}

	this.Tank.prototype.get_tank_width = function(){
		return this.tank_size.width;
	}

	this.Tank.prototype.get_tank_length = function(){
		return this.tank_size.length;
	}

	this.Tank.prototype.get_gun_width = function(){
		return this.gun_size.width;
	}

	this.Tank.prototype.get_gun_length = function(){
		return this.gun_size.length;
	}

	this.Tank.prototype.get_gun_tip = function(){
	...
	this.Tank.prototype.get_gun_pivot = function(){
	...
	this.Tank.prototype.render = function(){
	...
	this.Tank.prototype.checkTankCollision = function(tank_obj){
		//todo
		/*
	...
	*/
	...
	this.areTankOverlapping = function(tank_obj_a , tank_obj_b)
	{
		// check arguments
	...
	*/
	this.getTankBodyRect = function(tank_obj_a)
	{
		// check arguments
		if(tank_obj_a == null)
			return null;
	...
	/*
		...
		used for collision detection purpose.
	*/
	this.getTankGunRect = function(tank_obj_a)
	{
		//check arguments
		if(tank_obj_a == null)
			return null;
		...
		this.RectangularComponent = function(x_offset , y_offset , width ,length,color){
		...
		this.CircularComponent = function(x_offset , y_offset , radius,color){
		// x_offset x-axis offset from centre of the Tank
		// y_offset y-axis offset from centre of the Tank
