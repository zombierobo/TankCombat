Geometry = require('./lib_Geometry.js');
...
Tank.Tank.prototype.set_tank_position = function( position_vector){
...
Tank.Tank.prototype.set_gun_angle = function(angle){
	if(angle != null)
	{
		if(angle < 0)
			angle += 360;
...
Tank.Tank.prototype.set_tank_color = function(color){
	if(color == null)
		return;
...
Tank.Tank.prototype.get_gun_angle = function(){
	return this.tank_orientation.gun_angle;
}

Tank.Tank.prototype.get_tank_width = function(){
	return this.tank_size.width;
}

Tank.Tank.prototype.get_tank_length = function(){
	return this.tank_size.length;
}

Tank.Tank.prototype.get_gun_width = function(){
	return this.gun_size.width;
}

Tank.Tank.prototype.get_gun_length = function(){
	return this.gun_size.length;
}

Tank.Tank.prototype.get_gun_tip = function(){
...
Tank.Tank.prototype.get_gun_pivot = function(){
...
Tank.Tank.prototype.getTankBodyRect = function(){
	/*
...
Tank.Tank.prototype.getTankGunRect = function(){
...
var CircularComponent = function(x_offset , y_offset , radius,color){
	// x_offset x-axis offset from centre of the Tank
	// y_offset y-axis offset from centre of the Tank
