(function(){
	...
	var areRectangleOverlapping = Geometry.areRectangleOverlapping;

	var Tank = function (width , length , color){
		/*
	...
	Tank.prototype.render = function(ctx){
		...
		if(ctx == null)
		{
			console.log('ctx is null returning');
			return;
		}
		...
		{	
			...
			else if(component.constructor.name == "CircularComponent")
			{
				...
				console.log('component not identified');
			}
		}
	...
	var Bullet = function (width , length , color , current_position , projection_angle){
	...
	var areTankOverlapping = function(tank_obj_a , tank_obj_b){
		/*
	...
	var areBulletTankOverlapping = function(bullet_obj , tank_obj){
